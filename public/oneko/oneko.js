...
(async function oneko() {
  ...
  function create() {
    variant = parseLocalStorage("variant", "dog");
  ...
  function pickerModal() {
    ...
    function variantButton(variantEnum) {
      ...
      div.style.backgroundImage = `url('https://raw.githubusercontent.com/kyrie25/spicetify-oneko/main/assets/oneko/oneko-${variantEnum[1]}.gif')`;
