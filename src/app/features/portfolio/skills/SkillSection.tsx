...
const SKILLS_LIST: SkillListProps[] = [
  ...
  { image: "postgresql.svg", name: "postgres" },
    ...
    <section className="" id="skills">
      ...
      <Collapsible open={showDetailedSkills} onOpenChange={setShowDetailedSkills}>
        <CollapsibleTrigger className="flex items-center justify-center w-full py-2 hover:text-muted-foreground">{showDetailedSkills ?
          <ChevronsUp className="animate-bounce text-muted-foreground cursor-pointer" /> : <ChevronsDown className="animate-bounce text-muted-foreground cursor-pointer" />}</CollapsibleTrigger>
...
transition={{ duration: 0.5 }} className="space-y-2">
              ...
              <SkillCategory title="Other Tools and Technologies" skills={DEV_TOOLS} />
            </motion.div>
          </CollapsibleContent>
